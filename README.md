...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/cron-descriptor-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11876&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/cron-descriptor-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `cron-descriptor` can be installed with:

```
conda install cron-descriptor
```

It is possible to list all of the versions of `cron-descriptor` available on your platform with:
